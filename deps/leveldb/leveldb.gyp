{'targets': [{
  ...
  , 'include_dirs': [
        'leveldb-<(ldbversion)/'
      , 'leveldb-<(ldbversion)/include/'
      , 'leveldb-<(ldbversion)/include/utilities/'
      , 'leveldb-<(ldbversion)/include/rocksdb/'
    ]
  , 'conditions': [
        ['OS == "win"', {
            'include_dirs': [
  ...
  , 'sources': [
      ...
      , 'leveldb-<(ldbversion)/tools/db_stress.cc'
      , 'leveldb-<(ldbversion)/tools/ldb.cc'
      , 'leveldb-<(ldbversion)/tools/ldb_cmd.cc'
